...
✔ Only Numbers Mode – Accepts digits 0–9 (max 15 characters).<br>
✔ Color Output – You can choose color of your wish to print the output.<br>
✔ Menu-Driven Interface – Instant keypress navigation using msvcrt.getch().<br>
